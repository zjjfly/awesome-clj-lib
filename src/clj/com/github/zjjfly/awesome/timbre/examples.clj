(ns com.github.zjjfly.awesome.timbre.examples
  (:require
...
;xxx INFO [com.github.zjjfly.awesome.timbre.examples:7] - This will print out
;spy打印日志并附带原始的表达式
(spy :info (* 5 4 3 2 1))
;xxx INFO [com.github.zjjfly.awesome.timbre.examples:12] - (* 5 4 3 2 1) => 120
;使用get-env获取当前的局部变量
(defn my-mult [x y]
  (let [z (+ x y)]
   (info "Lexical env:" (get-env)) (* x y z)))
(my-mult 1 2)
;xxx INFO [com.github.zjjfly.awesome.timbre.examples:1] - Lexical env: {x 1, y 2}
